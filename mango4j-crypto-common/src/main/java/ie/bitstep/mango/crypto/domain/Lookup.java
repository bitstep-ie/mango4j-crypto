...
/**
 * Any application entities which use the {@code ListHmacFieldStrategy} and which have one or more
 * {@code @Hmac} fields with a {@code Hmac.Purposes#LOOKUP LOOKUP} purpose must implement this interface.
 */
public interface Lookup {
	 ...
	 * It's up to the entity to persist the {@code hmacHolders} correctly. This involves completely replacing the
