...
class HmacHolderTest {
	...
	void constructorAllParams() {
		HmacHolder hmacHolder = new HmacHolder(TestData.TEST_CRYPTO_KEY, TEST_DATA_TO_HMAC, TEST_DATA_HMAC_ALIAS, TEST_DATA_TOKENIZED_REPRESENTATION);

		assertThat(hmacHolder.getCryptoKey()).isEqualTo(TestData.TEST_CRYPTO_KEY);
	...
	void constructorNoRepresentation() {
		HmacHolder hmacHolder = new HmacHolder(TestData.TEST_CRYPTO_KEY, TEST_DATA_TO_HMAC, TEST_DATA_HMAC_ALIAS);
	...
	void constructorNoAlias() {
		HmacHolder hmacHolder = new HmacHolder(TestData.TEST_CRYPTO_KEY, TEST_DATA_TO_HMAC);
	...
	void setters() {
		...
		hmacHolder.setCryptoKey(TestData.TEST_CRYPTO_KEY);
	...
	void hashCodeTest() {
		...
		assertThat(hmacHolder.hashCode()).isEqualTo(544925164);
	}

	@SuppressWarnings("EqualsWithItself")
	@Test
	void equalsTestSameObject() {
		HmacHolder hmacHolder1 = new HmacHolder(TestData.TEST_CRYPTO_KEY, TEST_DATA_TO_HMAC, TEST_DATA_HMAC_ALIAS, TEST_DATA_TOKENIZED_REPRESENTATION);
	...
	void equals() {
		HmacHolder hmacHolder1 = new HmacHolder(TestData.TEST_CRYPTO_KEY, TEST_DATA_TO_HMAC, TEST_DATA_HMAC_ALIAS, TEST_DATA_TOKENIZED_REPRESENTATION);
		HmacHolder hmacHolder2 = new HmacHolder(TestData.TEST_CRYPTO_KEY, TEST_DATA_TO_HMAC, TEST_DATA_HMAC_ALIAS, TEST_DATA_TOKENIZED_REPRESENTATION);
	...
	void equalsDifferentCryptoKey() {
		...
		HmacHolder hmacHolder2 = new HmacHolder(TestData.TEST_CRYPTO_KEY, TEST_DATA_TO_HMAC, "Some Other Alias", TEST_DATA_TOKENIZED_REPRESENTATION);
	...
	void equalsDifferentValues() {
		HmacHolder hmacHolder1 = new HmacHolder(TestData.TEST_CRYPTO_KEY, TEST_DATA_TO_HMAC, TEST_DATA_HMAC_ALIAS, TEST_DATA_TOKENIZED_REPRESENTATION);
		HmacHolder hmacHolder2 = new HmacHolder(TestData.TEST_CRYPTO_KEY, "Some other value", TEST_DATA_HMAC_ALIAS, TEST_DATA_TOKENIZED_REPRESENTATION);
	...
	void equalsDifferentTokenizedRepresentations() {
		HmacHolder hmacHolder1 = new HmacHolder(TestData.TEST_CRYPTO_KEY, TEST_DATA_TO_HMAC, TEST_DATA_HMAC_ALIAS, TEST_DATA_TOKENIZED_REPRESENTATION);
		HmacHolder hmacHolder2 = new HmacHolder(TestData.TEST_CRYPTO_KEY, TEST_DATA_TO_HMAC, TEST_DATA_HMAC_ALIAS, "Some other tokenized representation");
