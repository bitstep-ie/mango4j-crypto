...
public class DefaultCiphertextFormatter implements CiphertextFormatter {
	...
	/**
	 * Basic constructor to create a {@link DefaultCiphertextFormatter} instance.
	 * @param cryptoKeyProvider - Your application's implementation of {@link CryptoKeyProvider}
	 */
	public DefaultCiphertextFormatter(CryptoKeyProvider cryptoKeyProvider, ObjectMapperFactory objectMapperFactory) {
