...
@ListHmacStrategy
public class TestAnnotatedEntityForListHmacFieldStrategyWithHmacOnlyUniqueGroupWithNoUniquePurpose implements Unique, Lookup {
	...
	@UniqueGroup(name = TEST_GROUP_NAME, order = 3)
