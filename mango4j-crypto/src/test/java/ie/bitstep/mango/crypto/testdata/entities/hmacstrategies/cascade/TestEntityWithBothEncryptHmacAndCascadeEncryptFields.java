...
public class TestEntityWithBothEncryptHmacAndCascadeEncryptFields {
	...
	public TestMockHmacEntity getTestMockHmacEntity1() {
		return testMockHmacEntity1;
	}

	public void setTestMockHmacEntity1(TestMockHmacEntity testMockHmacEntity1) {
		this.testMockHmacEntity1 = testMockHmacEntity1;
	}

	public TestMockHmacEntity getTestMockHmacEntity2() {
		return testMockHmacEntity2;
	}

	public void setTestMockHmacEntity2(TestMockHmacEntity testMockHmacEntity2) {
		this.testMockHmacEntity2 = testMockHmacEntity2;
	}

	public TestMockHmacEntity getTestMockHmacEntity3NotTraversed() {
		return testMockHmacEntity3NotTraversed;
	}

	public void setTestMockHmacEntity3NotTraversed(TestMockHmacEntity testMockHmacEntity3NotTraversed) {
		this.testMockHmacEntity3NotTraversed = testMockHmacEntity3NotTraversed;
	}
}