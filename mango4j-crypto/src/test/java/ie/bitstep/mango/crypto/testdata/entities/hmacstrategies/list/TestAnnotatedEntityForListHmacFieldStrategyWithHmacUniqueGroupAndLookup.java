...
@ListHmacStrategy
public class TestAnnotatedEntityForListHmacFieldStrategyWithHmacUniqueGroupAndLookup implements Lookup, Unique {

	public static final String TEST_GROUP_NAME = "test-group-1";

	@Encrypt
	@Hmac(purposes = {Hmac.Purposes.UNIQUE, Hmac.Purposes.LOOKUP})
	@UniqueGroup(name = TEST_GROUP_NAME, order = 1)
