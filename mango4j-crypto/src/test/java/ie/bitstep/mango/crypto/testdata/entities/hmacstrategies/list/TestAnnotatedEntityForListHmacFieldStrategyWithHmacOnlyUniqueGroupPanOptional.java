...
@ListHmacStrategy
public class TestAnnotatedEntityForListHmacFieldStrategyWithHmacOnlyUniqueGroupPanOptional implements Unique {

	public static final String TEST_GROUP_NAME = "test-group-1";

	@Encrypt
	@Hmac(purposes = Hmac.Purposes.UNIQUE)
	@UniqueGroup(name = TEST_GROUP_NAME, order = 1, isOptional = true)
