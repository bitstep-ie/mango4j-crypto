...
@ListHmacStrategy
public class TestAnnotatedEntityForListHmacFieldStrategyOptionalUnique implements Lookup, Unique {
	...
	@Encrypt
	@Hmac(purposes = {Hmac.Purposes.LOOKUP, Hmac.Purposes.UNIQUE}, isOptionalUnique = true)
