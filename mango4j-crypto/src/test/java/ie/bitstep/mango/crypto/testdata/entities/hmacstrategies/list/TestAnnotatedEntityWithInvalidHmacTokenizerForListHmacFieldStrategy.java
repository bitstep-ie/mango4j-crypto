...
import ie.bitstep.mango.crypto.testdata.implementations.tokenizers.TestInvalidHmacTokenizerNoDefaultConstructor;

import java.util.Collection;
import java.util.List;

@ListHmacStrategy
public class TestAnnotatedEntityWithInvalidHmacTokenizerForListHmacFieldStrategy implements Lookup, Unique {

	@Encrypt
	@Hmac(hmacTokenizers = TestInvalidHmacTokenizerNoDefaultConstructor.class)
